      ...
      <div className="py-4 px-3 rounded-lg shadow-light">
        ...
        <div className="my-5">
          ...
          <div className="shadow-2xl border rounded-lg my-2 p-2">
            ...
            <div onClick={reserveRent} className={`flex text-white gap-2 font-semibold cursor-pointer ${availability ? 'hover:text-green-500' : 'hover:text-red-500'} transition-all delay-200 hover:bg-black  bg-blue-500 py-2 px-3 hover:black rounded-xl mt-2`}>
              ...
              {availability ? <SlPaypal className="hover:text-green-500" /> : <FaCalendarXmark />}
            </div>
          </div>
        </div>
      </div>
