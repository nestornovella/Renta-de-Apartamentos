  ...
  return (
    <div className=" w-full justify-between flex items-center font-quicksand text-gray-400 gap-2 border mt-2 p-1 rounded-lg">
      <img
        src={images && images[0]}
        alt=""
        className="h-[50px] w-[80px] object-cover bg-center rounded-lg "
      />
      <div className="flex justify-between w-[180px] items-center">
        ...
        <span
          className={`border p-1 rounded-lg text-xs ${
            status.includes("rent") ? "bg-green-500" : "bg-red-500"
          }  text-white`}
        >
          {status}
        </span>
      ...
      <div className="flex gap-2">
        {type.includes("rent") && apartment.Anotations.length > 0 && (
          <div
            ...
            className=" animate-pulse  w-[40px] flex flex-col justify-center border border-yellow-500 p-1 rounded-lg items-center hover:bg-black  bg-yellow-200 text-yellow-500 hover:text-white transition-all delay-300 cursor-pointer"
          >
        ...
        <div
          ...
          className=" w-[40px] flex flex-col justify-center border p-1 rounded-lg items-center hover:bg-black text-blue-500 hover:text-white transition-all delay-300 cursor-pointer"
        >
        ...
        <div
          onClick={deleteApart}
          className=" w-[40px] flex flex-col justify-center border p-1 rounded-lg items-center hover:bg-black text-red-500 hover:text-white transition-all delay-300 cursor-pointer"
        >
