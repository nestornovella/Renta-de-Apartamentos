            ...
            <div className="flex flex-col items-center w-full ">
                {transaction.User &&
                    <div className="flex justify-between   w-full ">
                        ...
                        <div onClick={()=>getDetail(transaction.id)} className="flex size-11 flex-col justify-center items-center p-1 border rounded-lg text-blue-400 hover:text-white hover:bg-black cursor-pointer">
                            <button >
                                <FaFileInvoiceDollar className=""/>
                            </button>
                            <span className="text-xs text-gray-400 hover:text-white ">Detail</span>
                        </div>
