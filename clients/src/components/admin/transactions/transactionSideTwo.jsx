...
function SearchTranasaction({callBack}) {
    ...
    <div className="px-2">
      ...
      <div className="flex flex-col  justify-center mt-2">
        ...
        <div className="flex gap-3">
          <input ref={ref} type="text" className="border rounded-lg p-2 w-full" />
          <button onClick={()=>callBack(ref.current.value)} className="border rounded-lg bg-secondary hover:bg-black text-white cursor-pointer p-2">Search</button>
        </div>
        <div>
...
function TransactionSideTwo({ detail, resetDetail, callBack }) {
  return (
    <SideSection>
      <div>
      ...
      {detail ? (
        ...
        <SearchTranasaction callBack={callBack} />
      )}
